...
export default function sobreNos() {
        ...
        <section className="bg-white dark:bg-gray-900">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                ...
                <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    ...
                    <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 w-full">
                        <a href="#">
                            <Image className="m-5 w-40 h-55 rounded-full sm:rounded-full sm:rounded-full" src={Silas} alt="Jese Avatar" />
                        </a>
                        <div className="p-5">
                            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Silas Sousa Espinola</a>
                            </h3>
    ...
    <div className="p-5">
      <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
        <a href="#">Silas Espinola</a>
      </h3>
      <span className="text-gray-500 dark:text-gray-400">Desenvolvedor do projeto CTV</span>
      <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
        Olá! Meu nome é Silas, sou estudante de Análise e Desenvolvimento de Sistemas e já atuo no ramo da tecnologia. Tenho experiência em análise de dados e Power BI, áreas que me motivam pela capacidade de transformar informações em soluções práticas e visuais.
        <br /><br />
        ...
        <br /><br />
        Acredito que unir propósito e tecnologia é essencial: enquanto a tecnologia gera inovação, o propósito dá sentido ao que fazemos.
      </p>
    </div>
  </div>
</div>
