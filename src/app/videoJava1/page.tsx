export default function videoJava1() {
    return (
        <main className="flex flex-col items-center gap-20 justify-between p-24 dark:bg-gray-900">
            ...
            <div className="rounded-lg border-bg-gray-900 bg-gray-800 p-10 mb-10">
                <iframe width="700" height="415" src="https://www.youtube.com/embed/w19r6ILaso0?si=sZte7O16seBxYONT" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen className="d-flex justify-center rounded-lg border-bg-gray-900"></iframe>
            </div>
        </main>
