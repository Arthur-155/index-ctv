                        ...
                        <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="pt-6">
                                    ...
                                    <a href="/videoJava1" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Exercicio 1 - 3</a>
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="pt-6">
                                    ...
                                    <a href="/videoJava45" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Exercicio 4 - 5</a>
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="pt-6">
                                    ...
                                    <a href="/videoJava6" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Exercicio - 6</a>
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 flex flex-col">
                                ...
                                <div className="pt-6">
                                    ...
                                    <a href="/videoJava78" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Exercicios 7 - 8</a>
