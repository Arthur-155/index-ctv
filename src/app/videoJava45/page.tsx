export default function videoJava45() {
    return (
        <main className="flex flex-col items-center gap-20 justify-between p-24 dark:bg-gray-900">
            ...
            <div className="rounded-lg border-bg-gray-900 bg-gray-800 p-10 mb-10">
                <iframe width="700" height="415" src="https://www.youtube.com/embed/3dwBdiU1WlE?si=8CXZGU6ywj3PtHVF" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
            </div>
        </main>
    )
}